...
class Permiso extends DBAbstractModel{
    #propiedades
	public $rol_codigo;
    public $perm_codigo;
	public $perm_descripcion;
	public $rol_perm_estado;
	
	public function get_all($rol){
        $this->parametros = array($rol);
        $this->sp = "perm_roles_all";
        $this->executeSPConsulta();

        if (count($this->rows)>0){
            $this->mensaje="Permisos encontrados";
        }else{
            $this->mensaje="Permisos no encontrados";
        }
    }
