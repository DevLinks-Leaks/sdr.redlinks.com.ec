...
class Representante extends DBAbstractModel{
	...
	public function delete_repr_relacion( $alum_codi, $repr_codi )
	{   $this->parametros = array( );
        $this->query = "delete from tbl_persona_relacion where per_codi_1 = '".$alum_codi."' and per_codi_2 = '".$repr_codi."';";
        $this->executeSentenciaAccion();
		if($this->filasAfectadas>0)
		{   $this->mensaje="¡Exito! Relación Eliminada.";
        }else
		{   $this->mensaje="¡Error! No se pudo realizar el cambio.";
        }
		return $this;
    }
    # Método constructor
