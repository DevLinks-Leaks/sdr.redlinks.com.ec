...
//http://stackoverflow.com/questions/2013229/jquery-numeric-textbox-with-min-and-max-ranges
//PARA NOTAS EN EDUCALINKS, en el *.js, iría una línea de código así $('#diasProntopago_add').jStepper({minValue:0, maxValue:10, minLength:2, maxDecimals:2});
(function(jQuery) {
